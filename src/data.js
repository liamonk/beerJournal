export default [
  {
    ...
    style: "Pale Ale",
    styleGuideAddress: "",
    brewDate: "2024-06-02T00:00:00Z",
    reviewDate: "2024-07-16T00:00:00Z",
    description:
    ...
    review: "This beer came out pretty much as expected with one exception … a far higher than expected efficiency led to ~6% ABV!! (Oh and it was only Azacca hops in the end, el Dorado is going in the next brew) It doesn’t taste that strong and I’m happy with the result but it means it isn’t the easy drinker I expected. I think this is due to a smaller grain bill leading to high efficiency. The beer has a good bitterness, nice colour, and is clearer than it looks in the picture. I’d certainly brew this again, but reduce the grain bill to try to hit a lower ABV.",
    image: "goldenAle.JPG",
    rating: "4",
    abv: 6,
    ibu: 50,
  ...
  },
  {
    ...
    reviewDate: "2023-08-10T00:00:00Z",
    description:
  ...
  },
  {
    ...
    name: "Mummmmmm",
    style: "NZ Pilsner",
    styleGuideAddress: "https://en.wikipedia.org/wiki/Pilsner",
...

  {
    ...
    review:
      "Nice and hoppy with a surprising amount of malt sweetness for how dry the beer came out. Has kept well and is nice and crystal clear. Doesn't seem as high alcohol as it is and turned out to be pretty refreshing.",
    image: "coldipa.jpg",
    rating: "4.5/5",
    abv: 6.2,
    ibu: 35,
  ...
  },
  {
    ...
    review:
      "This was a yummy beer but there was a bit too much bitterness for such a dry beer. I also think I should have cut back on the roasted malt because it was a little astringent. Next time I'd definately add the cranberries too. Nice beer overall",
